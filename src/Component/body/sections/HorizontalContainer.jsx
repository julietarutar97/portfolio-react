...
const HorizontalContainer = ({tittle, info, elements, directionFlex}) => {
  return (
    <Flex as='section' justifyContent='center' fontFamily='Poppins, sans-serif' bg='#131313' color='white' direction='column' alignItems='center' w='100%' maxWidth='100vw'>
        <Flex direction='row' justifyContent='space-around' textAlign='left'  w='100vw' paddingLeft='200px' paddingRight='200px'>
            ...
            <Box as='section' display='flex' flexDirection={directionFlex} flexWrap='nowrap'  alignItems='flex-end'>
